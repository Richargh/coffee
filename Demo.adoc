...
You can reference images image:icons/fontawsome/solid/anchor.svg[Anchor, title="Anchor"] inline or as a block:
...
.Table with three columns, a header, and one row of content
|===
|Name
|Role
|Description
